...
import './css/GrammarTestScreen.css';
...
const GrammarTestScreen = ({
  ...
  return (
    <div className="active-test-screen grammar-test">
      ...
      <div className="question-content-area grammar-content">
        <div className="question-display">
          <h3 className="grammar-question-text">
        ...
        <div className="options-list grammar-options">
          {currentQuestion.answers.map((answer) => (
            <div 
              key={answer.id}
              className={`grammar-option ${getAnswerClass(answer)}`}
