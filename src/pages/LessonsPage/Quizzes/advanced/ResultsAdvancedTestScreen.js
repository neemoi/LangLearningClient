...
const ResultsAdvancedTestScreen = ({ 
  score, 
  totalQuestions, 
  errors, 
  time, 
    ...
    <div className="results-container">
      <div className="results-content">
        <header className="results-header">
          ...
          <p className="results-subtitle">Улучшенная векторизация</p>
        </header>
...
export default ResultsAdvancedTestScreen;